# MetropolitanoDeLisboa SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MetropolitanoDeLisboaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MetropolitanoDeLisboaSDK(...) and MetropolitanoDeLisboaSDK.test(...) become
#      MetropolitanoDeLisboaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "metropolitanodelisboa_sdk"
_SDK_CLASS = "MetropolitanoDeLisboaSDK"
