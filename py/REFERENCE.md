# MetropolitanoDeLisboa Python SDK Reference

Complete API reference for the MetropolitanoDeLisboa Python SDK.
...
#### `MetropolitanoDeLisboaSDK.test(testopts=None, sdkopts=None)`
