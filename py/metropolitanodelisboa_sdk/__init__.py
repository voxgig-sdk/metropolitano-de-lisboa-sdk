...
from metropolitanodelisboa_sdk.utility import register

# Load features
from metropolitanodelisboa_sdk.feature.base_feature import MetropolitanoDeLisboaBaseFeature
from metropolitanodelisboa_sdk.features import _has_feature, _make_feature
...
class MetropolitanoDeLisboaSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MetropolitanoDeLisboaUtility()
        self._utility = utility

        from metropolitanodelisboa_sdk.config import shared_config
    ...
    def get_utility(self):
        return MetropolitanoDeLisboaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MetropolitanoDeLisboaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Network(self, data=None) -> "NetworkEntity":
        ...
        from metropolitanodelisboa_sdk.entity.network_entity import NetworkEntity
