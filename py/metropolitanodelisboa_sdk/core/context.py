...
from metropolitanodelisboa_sdk.core.helpers import get_ctx_prop, to_map
...
class MetropolitanoDeLisboaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MetropolitanoDeLisboaControl()
        ...
        if isinstance(sp, MetropolitanoDeLisboaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MetropolitanoDeLisboaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MetropolitanoDeLisboaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MetropolitanoDeLisboaOperation({})
    ...
    def make_error(self, code, msg):
        return MetropolitanoDeLisboaError(code, msg, self)
