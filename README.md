...
The Lisbon Metro API provides access to comprehensive data on the Lisbon Metro system, including historical and current information about stations, lines, schedules, and passenger statistics.

Learn more about Metropolitano de Lisboa at [metrolisboa.pt](https://metrolisboa.pt).

This is an unofficial SDK for the Metropolitano de Lisboa public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
