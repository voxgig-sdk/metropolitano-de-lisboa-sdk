// Command MetropolitanoDeLisboa-mcp is an MCP server exposing the MetropolitanoDeLisboa
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MetropolitanoDeLisboa_list  — list records of an entity
//	MetropolitanoDeLisboa_load  — load a single record of an entity
//
