...
type Args struct {
	Entity string         `json:"entity" jsonschema:"network"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MetropolitanoDeLisboaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "metropolitano-de-lisboa_list",
		Description: "List records from MetropolitanoDeLisboa. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "metropolitano-de-lisboa_load",
		Description: "Load a single record from MetropolitanoDeLisboa. " +
...
func runOp(client *sdk.MetropolitanoDeLisboaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MetropolitanoDeLisboaSDK, name string) (sdk.MetropolitanoDeLisboaEntity, error) {
