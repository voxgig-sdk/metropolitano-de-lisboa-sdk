...
// instead of `sdk.NewMetropolitanoDeLisboaSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MetropolitanoDeLisboaSDK  { return NewMetropolitanoDeLisboaSDK(nil) }
func Test() *MetropolitanoDeLisboaSDK { return TestSDK(nil, nil) }
