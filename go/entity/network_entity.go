...
type NetworkEntity struct {
	name    string
	client  *core.MetropolitanoDeLisboaSDK
...
func NewNetworkEntity(client *core.MetropolitanoDeLisboaSDK, entopts map[string]any) *NetworkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NetworkEntity) GetName() string { return e.name }
...
func (e *NetworkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NetworkEntity) Deleted() bool {
	return e.deleted
}


func (e *NetworkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNetworkEntity(e.client, opts)
}

func (e *NetworkEntity) Data(args ...any) any {
...
func (e *NetworkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Network; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NetworkEntity) DataTyped(data ...Network) Network {
	if len(data) > 0 {
		return typedFrom[Network](e.Data(asMap(data[0])))
	}
	return typedFrom[Network](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Network (all fields
// optional at the wire level).
func (e *NetworkEntity) MatchTyped(match ...Network) Network {
	if len(match) > 0 {
		return typedFrom[Network](e.Match(asMap(match[0])))
	}
	return typedFrom[Network](e.Match())
}
...
func (e *NetworkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NetworkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NetworkLoadMatch and returns an Network. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NetworkEntity) LoadTyped(reqmatch NetworkLoadMatch, ctrl map[string]any) (Network, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Network{}, err
	}
	return typedFrom[Network](res), nil
}



func (e *NetworkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NetworkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NetworkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NetworkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NetworkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
