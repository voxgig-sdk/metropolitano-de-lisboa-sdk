...
func TestNetworkEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set METROPOLITANODELISBOA_TEST_NETWORK_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func networkBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("METROPOLITANODELISBOA_TEST_NETWORK_ENTID")
