...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("METROPOLITANODELISBOA_TEST_LIVE") == "TRUE" ||
		os.Getenv("METROPOLITANODELISBOA_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("METROPOLITANODELISBOA_TEST_EXPLAIN"); explain != "" {
