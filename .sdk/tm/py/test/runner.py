...
class MetropolitanoDeLisboaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MetropolitanoDeLisboaTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MetropolitanoDeLisboaTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MetropolitanoDeLisboaTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
