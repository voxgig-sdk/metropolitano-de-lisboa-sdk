...
// MetropolitanoDeLisboa SDK utility type

class MetropolitanoDeLisboaUtility
{
    ...
    public static function copy(MetropolitanoDeLisboaUtility $src): MetropolitanoDeLisboaUtility
    {
        $u = new MetropolitanoDeLisboaUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
