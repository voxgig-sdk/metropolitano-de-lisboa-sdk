...
// MetropolitanoDeLisboa SDK utility: result_basic

class MetropolitanoDeLisboaResultBasic
{
    public static function call(MetropolitanoDeLisboaContext $ctx): ?MetropolitanoDeLisboaResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof MetropolitanoDeLisboaError) ? $result->err->msg : (string)$result->err;
