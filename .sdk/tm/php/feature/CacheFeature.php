...
// MetropolitanoDeLisboa SDK cache feature
...
class MetropolitanoDeLisboaCacheFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _through(MetropolitanoDeLisboaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
