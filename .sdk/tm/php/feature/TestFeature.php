...
// MetropolitanoDeLisboa SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MetropolitanoDeLisboaTestFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    public function init(MetropolitanoDeLisboaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MetropolitanoDeLisboaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MetropolitanoDeLisboaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MetropolitanoDeLisboaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MetropolitanoDeLisboaContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MetropolitanoDeLisboaParam::call($ctx, $k);
