...
// MetropolitanoDeLisboa SDK ratelimit feature
...
class MetropolitanoDeLisboaRatelimitFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _acquire(MetropolitanoDeLisboaContext $ctx): void
    {
    ...
    private function _track(MetropolitanoDeLisboaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
