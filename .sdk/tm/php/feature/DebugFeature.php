...
// MetropolitanoDeLisboa SDK debug feature
...
class MetropolitanoDeLisboaDebugFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _finish(MetropolitanoDeLisboaContext $ctx, bool $ok): void
    {
