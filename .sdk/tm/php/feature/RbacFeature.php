...
// MetropolitanoDeLisboa SDK rbac feature
...
class MetropolitanoDeLisboaRbacFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _required(MetropolitanoDeLisboaContext $ctx): ?string
    {
    ...
    private function _reject(MetropolitanoDeLisboaContext $ctx, string $required): void
    {
    ...
    private function _track(MetropolitanoDeLisboaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
