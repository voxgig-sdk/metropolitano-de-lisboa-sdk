...
// MetropolitanoDeLisboa SDK idempotency feature
...
class MetropolitanoDeLisboaIdempotencyFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _mutating(MetropolitanoDeLisboaContext $ctx): bool
    {
