...
|---|---|---|
| `ts/` | @voxgig-sdk/metropolitano-de-lisboa-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/metropolitano-de-lisboa-sdk \
      --repository voxgig-sdk/metropolitano-de-lisboa-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/metropolitano-de-lisboa-sdk` shows it, and
`npm trust revoke @voxgig-sdk/metropolitano-de-lisboa-sdk --id=<id>` removes it.
