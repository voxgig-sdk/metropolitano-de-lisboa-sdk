# MetropolitanoDeLisboa Lua SDK Reference

Complete API reference for the MetropolitanoDeLisboa Lua SDK.
...
```lua
local result, err = client:Network(nil):load({ id = "network_id" }, nil)
```
