...
describe("NetworkEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set METROPOLITANO_DE_LISBOA_TEST_NETWORK_ENTID JSON to run live")
      return
    end
...
function network_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("METROPOLITANO_DE_LISBOA_TEST_NETWORK_ENTID")
  ...
  if env["METROPOLITANO_DE_LISBOA_TEST_LIVE"] == "TRUE" then
