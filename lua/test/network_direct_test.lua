...
describe("NetworkDirect", function()
  it("should direct-load-network", function()
    local setup = network_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-network", setup.live and "live" or "unit")
