...
func registerSDKWords(r *eng.Registry, client *sdk.MetropolitanoDeLisboaSDK) {
...
func runOp(client *sdk.MetropolitanoDeLisboaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
