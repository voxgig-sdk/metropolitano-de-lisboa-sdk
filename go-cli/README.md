...
AQL-driven CLI and REPL for the MetropolitanoDeLisboa SDK. Positional arguments are
...
```sh
go build -o metropolitano-de-lisboa-cli ./...
```
...
./metropolitano-de-lisboa-cli list network
./metropolitano-de-lisboa-cli load 1 network
./metropolitano-de-lisboa-cli load '{id:1}' network
