...
Results: Successful response with network information.
...
| --- | --- | --- | --- |
| Network | `load` | `GET /network` | See reference |

## Connect to the API

- Production server: `https://api.metrolisboa.pt/v1`
...
- `metropolitano-de-lisboa_list`: List records for an entity. No active entity supports this operation.
- `metropolitano-de-lisboa_load`: Load one record for an entity. Supported entities: `network`.
