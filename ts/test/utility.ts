...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.METROPOLITANODELISBOA_TEST_LIVE ||
    'TRUE' === process.env.METROPOLITANODELISBOA_TEST_OVERRIDE
  ) {
  ...
  m.METROPOLITANODELISBOA_TEST_EXPLAIN = process.env.METROPOLITANODELISBOA_TEST_EXPLAIN || m.METROPOLITANODELISBOA_TEST_EXPLAIN
