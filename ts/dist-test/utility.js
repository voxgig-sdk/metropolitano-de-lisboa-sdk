...
function envOverride(m) {
    if ('TRUE' === process.env.METROPOLITANO_DE_LISBOA_TEST_LIVE ||
        'TRUE' === process.env.METROPOLITANO_DE_LISBOA_TEST_OVERRIDE) {
    ...
    m.METROPOLITANO_DE_LISBOA_TEST_EXPLAIN = process.env.METROPOLITANO_DE_LISBOA_TEST_EXPLAIN || m.METROPOLITANO_DE_LISBOA_TEST_EXPLAIN;
    return m;
}
