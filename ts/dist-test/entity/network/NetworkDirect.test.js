...
(0, node_test_1.describe)('NetworkDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MetropolitanoDeLisboaSDK({
    ...
    (0, node_test_1.test)('direct-load-network', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-network', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.METROPOLITANO_DE_LISBOA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MetropolitanoDeLisboaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['METROPOLITANO_DE_LISBOA_TEST_NETWORK_ENTID'];
    ...
    const client = new __1.MetropolitanoDeLisboaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=NetworkDirect.test.js.map