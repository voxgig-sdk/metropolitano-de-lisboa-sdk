...
exports.MetropolitanoDeLisboaEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends MetropolitanoDeLisboaEntityBase<Advice>`.
class MetropolitanoDeLisboaEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.MetropolitanoDeLisboaEntityBase = MetropolitanoDeLisboaEntityBase;
//# sourceMappingURL=MetropolitanoDeLisboaEntityBase.js.map