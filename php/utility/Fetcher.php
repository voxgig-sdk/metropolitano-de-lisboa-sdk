...
// MetropolitanoDeLisboa SDK utility: fetcher

class MetropolitanoDeLisboaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MetropolitanoDeLisboaSDK/1.0)';
    ...
    public static function call(MetropolitanoDeLisboaContext $ctx, string $fullurl, array $fetchdef): array
    {
