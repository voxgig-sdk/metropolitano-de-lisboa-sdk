...
// MetropolitanoDeLisboa SDK utility: make_options

class MetropolitanoDeLisboaMakeOptions
{
    ...
    public static function call(MetropolitanoDeLisboaContext $ctx): array
    {
        ...
        //
        // `MetropolitanoDeLisboaSchema::optspec()` is built from the model:
        ...
        $optspec = MetropolitanoDeLisboaSchema::optspec();
