...
// MetropolitanoDeLisboa SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MetropolitanoDeLisboaMakeRequest
{
    public static function call(MetropolitanoDeLisboaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MetropolitanoDeLisboaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MetropolitanoDeLisboaResponse($fetched);
        } else {
