...
// MetropolitanoDeLisboa SDK utility: graphql
//
...
class MetropolitanoDeLisboaGraphql
{
    ...
    // equivalent.
    public static function body(MetropolitanoDeLisboaContext $ctx): mixed
    {
    ...
    public static function errors(MetropolitanoDeLisboaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
