...
class NetworkDirectTest extends TestCase
{
    public function test_direct_load_network(): void
    {
        $setup = network_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-network", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function network_direct_setup($mockres)
{
