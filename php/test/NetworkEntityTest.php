...
class NetworkEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set METROPOLITANODELISBOA_TEST_NETWORK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function network_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("METROPOLITANODELISBOA_TEST_NETWORK_ENTID");
