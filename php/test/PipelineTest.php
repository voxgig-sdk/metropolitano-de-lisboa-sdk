...
// MetropolitanoDeLisboa SDK pipeline test
//
...
require_once __DIR__ . '/../metropolitanodelisboa_sdk.php';
...
{
    private static function utility(): MetropolitanoDeLisboaUtility
    {
        return new MetropolitanoDeLisboaUtility();
    }
    ...
    private static function ctx(array $over = []): MetropolitanoDeLisboaContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MetropolitanoDeLisboaContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MetropolitanoDeLisboaOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MetropolitanoDeLisboaError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MetropolitanoDeLisboaOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MetropolitanoDeLisboaMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MetropolitanoDeLisboaOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MetropolitanoDeLisboaMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MetropolitanoDeLisboaOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MetropolitanoDeLisboaMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MetropolitanoDeLisboaSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MetropolitanoDeLisboaMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MetropolitanoDeLisboaResponse([]),
            'result' => new MetropolitanoDeLisboaResult([]),
        ]);
        [, $err] = MetropolitanoDeLisboaMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MetropolitanoDeLisboaSpec([]),
            'response' => null,
            'result' => new MetropolitanoDeLisboaResult([]),
        ]);
        [, $err] = MetropolitanoDeLisboaMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MetropolitanoDeLisboaSpec(['step' => 's']),
            'response' => new MetropolitanoDeLisboaResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MetropolitanoDeLisboaResult([]),
        ]);
        [, $err] = MetropolitanoDeLisboaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MetropolitanoDeLisboaSpec(['step' => 's']),
            'response' => new MetropolitanoDeLisboaResponse(self::resp(200, ['v' => 1])),
            'result' => new MetropolitanoDeLisboaResult([]),
        ]);
        [, $err] = MetropolitanoDeLisboaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MetropolitanoDeLisboaSpec(['step' => 's']),
            'response' => new MetropolitanoDeLisboaResponse(self::resp(200, ['v' => 2])),
            'result' => new MetropolitanoDeLisboaResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MetropolitanoDeLisboaMakeResponse::call($ctx);
    ...
    {
        $preset = new MetropolitanoDeLisboaResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MetropolitanoDeLisboaSpec([]),
            'response' => new MetropolitanoDeLisboaResponse([]),
            'result' => new MetropolitanoDeLisboaResult([]),
        ...
        [$got, $err] = MetropolitanoDeLisboaMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MetropolitanoDeLisboaResult([])]);
        [, $err] = MetropolitanoDeLisboaMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MetropolitanoDeLisboaSpec([]), 'result' => null]);
        [, $err] = MetropolitanoDeLisboaMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MetropolitanoDeLisboaSpec(['step' => 's']),
            'result' => new MetropolitanoDeLisboaResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MetropolitanoDeLisboaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MetropolitanoDeLisboaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MetropolitanoDeLisboaSpec(['step' => 's']),
            'result' => new MetropolitanoDeLisboaResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MetropolitanoDeLisboaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MetropolitanoDeLisboaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MetropolitanoDeLisboaResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MetropolitanoDeLisboaSpec([]),
            'result' => new MetropolitanoDeLisboaResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MetropolitanoDeLisboaMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MetropolitanoDeLisboaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MetropolitanoDeLisboaError('boom', 'boom');
        $utility->fetcher = function (MetropolitanoDeLisboaContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MetropolitanoDeLisboaSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MetropolitanoDeLisboaMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MetropolitanoDeLisboaContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MetropolitanoDeLisboaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MetropolitanoDeLisboaResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MetropolitanoDeLisboaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MetropolitanoDeLisboaContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MetropolitanoDeLisboaSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MetropolitanoDeLisboaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MetropolitanoDeLisboaResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MetropolitanoDeLisboaSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MetropolitanoDeLisboaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MetropolitanoDeLisboaMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MetropolitanoDeLisboaMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MetropolitanoDeLisboaResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MetropolitanoDeLisboaDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MetropolitanoDeLisboaResult(['ok' => false])]);
        $this->expectException(MetropolitanoDeLisboaError::class);
        MetropolitanoDeLisboaDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MetropolitanoDeLisboaResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MetropolitanoDeLisboaMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MetropolitanoDeLisboaMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MetropolitanoDeLisboaBaseFeature();
        $b = new MetropolitanoDeLisboaBaseFeature();
        MetropolitanoDeLisboaFeatureAdd::call($ctx, $a);
        MetropolitanoDeLisboaFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MetropolitanoDeLisboaBaseFeature
    {
        $f = new MetropolitanoDeLisboaBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MetropolitanoDeLisboaFeatureAdd::call($ctx, self::named_feature('a'));
        MetropolitanoDeLisboaFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MetropolitanoDeLisboaFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MetropolitanoDeLisboaFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MetropolitanoDeLisboaFeatureAdd::call($ctx, $replace);
        ...
        MetropolitanoDeLisboaFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MetropolitanoDeLisboaContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MetropolitanoDeLisboaSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MetropolitanoDeLisboaPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MetropolitanoDeLisboaPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MetropolitanoDeLisboaResponse(['headers' => null]),
            'result' => new MetropolitanoDeLisboaResult([]),
        ]);
        MetropolitanoDeLisboaResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MetropolitanoDeLisboaResultBody::call($ctx);
