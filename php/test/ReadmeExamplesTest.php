...
// MetropolitanoDeLisboa SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MetropolitanoDeLisboaSDK::test)
...
{
    private const SDK_CLASS = 'MetropolitanoDeLisboaSDK';
    ...
    private const SDK_BASE = 'metropolitanodelisboa_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../metropolitanodelisboa_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
