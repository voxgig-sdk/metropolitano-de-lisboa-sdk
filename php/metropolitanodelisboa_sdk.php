...
class MetropolitanoDeLisboaSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = MetropolitanoDeLisboaHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = MetropolitanoDeLisboaHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!MetropolitanoDeLisboaFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, MetropolitanoDeLisboaFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return MetropolitanoDeLisboaUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = MetropolitanoDeLisboaHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = MetropolitanoDeLisboaHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = MetropolitanoDeLisboaHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new MetropolitanoDeLisboaError($op . "_allow",
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = MetropolitanoDeLisboaHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new MetropolitanoDeLisboaError("graphql_error",
                "MetropolitanoDeLisboaSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new MetropolitanoDeLisboaSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
