...
// MetropolitanoDeLisboa SDK streaming feature
...
class MetropolitanoDeLisboaStreamingFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _iterate(MetropolitanoDeLisboaResult $result): \Generator
    {
    ...
    private function _streamable(MetropolitanoDeLisboaContext $ctx): bool
    {
