...
// MetropolitanoDeLisboa SDK metrics feature
...
class MetropolitanoDeLisboaMetricsFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _record(MetropolitanoDeLisboaContext $ctx, bool $ok): void
    {
