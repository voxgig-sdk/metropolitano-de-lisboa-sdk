...
// MetropolitanoDeLisboa SDK audit feature
...
class MetropolitanoDeLisboaAuditFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _emit(MetropolitanoDeLisboaContext $ctx, string $outcome): void
    {
