...
// MetropolitanoDeLisboa SDK paging feature
...
class MetropolitanoDeLisboaPagingFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _is_list(MetropolitanoDeLisboaContext $ctx): bool
    {
