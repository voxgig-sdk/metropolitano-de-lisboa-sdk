...
// MetropolitanoDeLisboa SDK telemetry feature
...
class MetropolitanoDeLisboaTelemetryFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _close(MetropolitanoDeLisboaContext $ctx, bool $ok): void
    {
