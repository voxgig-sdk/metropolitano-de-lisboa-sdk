...
// MetropolitanoDeLisboa SDK timeout feature
...
class MetropolitanoDeLisboaTimeoutFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _with_timeout(MetropolitanoDeLisboaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MetropolitanoDeLisboaContext $_ctx, float $ms): void
    {
        $client = $this->client;
