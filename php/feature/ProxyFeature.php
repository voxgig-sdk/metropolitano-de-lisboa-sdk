...
// MetropolitanoDeLisboa SDK proxy feature
...
class MetropolitanoDeLisboaProxyFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    public function init(MetropolitanoDeLisboaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MetropolitanoDeLisboaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
