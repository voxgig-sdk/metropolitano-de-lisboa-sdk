...
// MetropolitanoDeLisboa SDK clienttrack feature
...
class MetropolitanoDeLisboaClienttrackFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    public function PostConstruct(MetropolitanoDeLisboaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MetropolitanoDeLisboa-SDK';
