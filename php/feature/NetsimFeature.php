...
// MetropolitanoDeLisboa SDK netsim feature
...
class MetropolitanoDeLisboaNetsimFeature extends MetropolitanoDeLisboaBaseFeature
{
    ...
    private function _simulate(MetropolitanoDeLisboaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MetropolitanoDeLisboaContext $ctx, array $applied): void
    {
        $client = $this->client;
