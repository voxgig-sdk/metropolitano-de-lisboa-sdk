# MetropolitanoDeLisboa Ruby SDK Reference

Complete API reference for the MetropolitanoDeLisboa Ruby SDK.
...
#### `MetropolitanoDeLisboaSDK.test(testopts = nil, sdkopts = nil)`
