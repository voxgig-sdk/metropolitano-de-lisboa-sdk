...
#      offline in seeded test mode (MetropolitanoDeLisboaSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MetropolitanoDeLisboa_sdk.rb")
  SDK_CLASS = "MetropolitanoDeLisboaSDK"
  ...
  SDK_BASE = "MetropolitanoDeLisboa_sdk"
