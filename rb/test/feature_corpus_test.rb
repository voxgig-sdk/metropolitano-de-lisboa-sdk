# MetropolitanoDeLisboa SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # MetropolitanoDeLisboaSDK.new, not MetropolitanoDeLisboaSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    MetropolitanoDeLisboaSDK.new(opts)
  end
