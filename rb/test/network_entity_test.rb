...
class NetworkEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set METROPOLITANO_DE_LISBOA_TEST_NETWORK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def network_basic_setup(extra)
  ...
  entid_env_raw = ENV["METROPOLITANO_DE_LISBOA_TEST_NETWORK_ENTID"]
